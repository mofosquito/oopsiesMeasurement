...
public class estimating_quantities_page1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estimating_quantities_page1);
        ...
        buttonHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int3 = new Intent(estimating_quantities_page1.this, MainActivity.class);
                startActivity(int3);
            }
        });
    }
