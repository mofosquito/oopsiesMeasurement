...
public class length_mass_time_page1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_length_mass_time_page1);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(length_mass_time_page1.this, length_mass_time_page2.class);
                startActivity(int1);
            }
        });
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int2 = new Intent(length_mass_time_page1.this, Educational.class);
                startActivity(int2);
            }
        });
        ...
        buttonHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int3 = new Intent(length_mass_time_page1.this, MainActivity.class);
                startActivity(int3);
            }
        });
    }
